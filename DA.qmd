...
Modifications to DeepAcoustics allowed for a broadened scope that prioritizes **underwater acoustic environments and species**, while still accommodating **in-air terrestrial counterparts**. These enhancements extend the tool’s functionality beyond previous platforms, such as DeepSqueak, with key improvements including:
...
For more information on the original tool developed by Dr. Kevin Coffey, please visit the [DeepSqueak](https://github.com/DrCoffey/DeepSqueak) repository.
...
**Development:** DeepAcoustics is a joint accessible tool venture development lead by [Acoustic Interactions](https://acousticinteractions.org/vision-mission) and supported by [Ocean Science Analytics](https://www.oceanscienceanalytics.com/).
